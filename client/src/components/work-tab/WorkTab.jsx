...
const WorkTab = () => {
    ...
    return (
        <div className='work-tab'>
            ...
            <Table head={['П.І.П', 'Факультет', 'Кафедра', 'Лабораторія', 'Посада', 'Початок перебування', 'Кінець перебування', 'Робота', 'Замовник', 'Адреса замовника', 'Підпорядкування', 'Галузь', 'Звіт']} list={transformList(list)} />
        </div>
    );
};
